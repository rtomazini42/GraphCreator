...
begin
  ...
  begin
    ShowMessage('Não pode ser maior que 200%');
  end
  else
  begin
     // Verifique se o campo de etiqueta não está vazio
  ...
  begin
    ...
    begin
      ShowMessage('O valor inserido não é um número válido.');
    end;
  end
  else
  begin
    ShowMessage('A etiqueta não pode estar em branco.');
  end;
...
begin
  ...
  begin
    ...
    // Você pode realizar outras ações com os itens aqui
  end;
end;
